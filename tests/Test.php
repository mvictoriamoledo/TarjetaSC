...
class TarjetaTest extends TestCase {
  ...
  public function testTransbordoConMedio() {
	...
	$tarje= new Tarjetas("estudiante", "Medio boleto");
	$tarje->recargar(272);
	$tarje->pagar($bondi1,"18.52","miercoles");
	$bondi= new Colectivos("145");
	$tarje->pagar($bondi,"19.12","miercoles");
  ...
  public function testTransbordoSinMedio() {
	...
	$tarje->recargar(272);
	$bondi= new Colectivos("144");
	$tarje->pagar($bondi,"18.52","jueves");
        $bondi1= new Colectivos("145");
	$tarje->pagar($bondi1,"19.12","jueves");
	$this->assertEquals($tarje->saldo(), 309.26, "Cuando cargo 272 deberia tener finalmente 320 y paga 8 el primer viaje y 2.64 de trasbordo");
  }
  ...
  public function testNoTransbordoMedio() {
	...
	$tarje= new Tarjetas("estudiante", "Medio boleto");
	$tarje->recargar(272);
	$tarje->pagar($bondi1,"18.52","viernes");
	$bondi= new Colectivos("145");
	$tarje->pagar($bondi,"20.30","viernes");
  ...
  public function testNoTransbordoNormal() {
	...
	$tarje->recargar(272);
	$bondi= new Colectivos("144");
	$tarje->pagar($bondi,"18.52","domingo");
        $bondi1= new Colectivos("145");
	$tarje->pagar($bondi1,"20.30","domingo");
   ...
   public function testViajeEnBici() {
	...
	$tarje->pagar($velo,"18.52","viernes");
